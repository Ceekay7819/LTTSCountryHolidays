...
using HolidaysCalculator.API.Filters;
using HolidaysCalculator.API.Services;
using MediatR;
using Microsoft.AspNetCore.Http;
using Microsoft.AspNetCore.Mvc;

namespace HolidaysCalculator.API.Controllers
{
    [ApiController]
    [Route("api/holidays")]
    public class HolidayCalculatorController : ControllerBase
    {
        private readonly IMediator _mediator;

        public HolidayCalculatorController(IMediator mediator)
        {
            _mediator = mediator;
        }
        ...
        [RequestLimit(Name = "GetCountryWithMostHolidaysByYear", Seconds = 3)]
        ...
        [RequestLimit(Name = "GetMonthWithMostHolidaysByYear", Seconds = 3)]
        [ProducesResponseType(typeof(string), StatusCodes.Status200OK)]
        ...
        [RequestLimit(Name = "GetCountryWithMostUniqueHolidaysByYear", Seconds = 3)]
        [ProducesResponseType(typeof(string), StatusCodes.Status200OK)]
